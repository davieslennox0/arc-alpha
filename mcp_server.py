...
def mcp_manifest():
    ...
    return {
        ...
        "tools": [
            ...
            {
                "name": "get_signal",
                "description": "Get full directional trading signal for an asset. Costs $0.01 USDC on Arc.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "asset":    {"type": "string", "description": "Crypto ticker"},
                        "tx_hash":  {"type": "string", "description": "Payment tx hash — send $0.01 USDC to broker wallet first"}
                    },
            ...
            },
            {
                ...
                "description": "Submit your own signal for Risk Agent validation. Returns position size, SL/TP. Costs $0.02 USDC.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "asset":      {"type": "string"},
            ...
            {
                "name": "execute_trade",
                "description": "Execute a Uniswap V3 swap on Arc. Risk + Learning + Execution pipeline. Costs $0.05 USDC.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "asset":       {"type": "string"},
                        "direction":   {"type": "string", "enum": ["UP", "DOWN"]},
                        "amount_usdt": {"type": "number", "description": "Trade size in USDC"},
            ...
            {
                "name": "full_broker",
                "description": "Full pipeline — Scout, Risk, Learning, Execution all in one call. Costs $0.02 USDC.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "asset":    {"type": "string"},
