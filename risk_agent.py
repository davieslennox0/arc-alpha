...
RPC_URL = os.getenv("RPC_URL", "https://rpc.testnet.arc-node.thecanteenapp.com/v1/swrm_c05652a524a12054fafb7bfbe9c5377ca74495ac572e34f0270f296f9ad5cdcc")
...
if __name__ == "__main__":
    ...
    print(f"Portfolio value: ${pv} USDC")
